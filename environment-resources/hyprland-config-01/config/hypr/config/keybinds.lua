...
hl.bind(main_mod .. " + grave", exec("hyprctl reload"))
hl.bind(main_mod .. " + SPACE", exec(menu))
...
hl.bind(main_mod .. " + 6", exec("cqrlog"))
hl.bind(main_mod .. " + 9", exec("discord"))

-- Flatpak bind run version
hl.bind(main_mod .. " + 0", exec("audacious"))

-- AUR bind run version
