...
# Zamiana KB na GB z dokładnością do 1 miejsca po przecinku
...
# Linia 1: co ma być na pasku
echo " ${used_percent}%"

# Linia 2: co ma być w tooltipie
echo "ROOT: ${used_gb} GiB / ${total_gb} GiB (free: ${free_gb} GiB)"
